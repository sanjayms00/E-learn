...
export declare class StudentCourseController {
    ...
    constructor(studentCourseService: StudentCourseService, configService: ConfigService);
    home(): Promise<{
        courses: any[];
        allCounts: {
            courseCount: number;
    ...
    searchCourse(searchText: any): Promise<any[]>;
    courseDetails(courseId: string): Promise<any>;
    getInstructors(): Promise<(import("mongoose").Document<unknown, {}, import("../../instructor/schema/instructor.schema").Instructor> & import("../../instructor/schema/instructor.schema").Instructor & {
        _id: import("mongoose").Types.ObjectId;
    })[]>;
    getcategories(): Promise<(import("mongoose").Document<unknown, {}, import("../../admin/schema/category.schema").Category> & import("../../admin/schema/category.schema").Category & {
        _id: import("mongoose").Types.ObjectId;
    })[]>;
    filterCourse(level?: string, instructor?: number, category?: number): Promise<any[]>;
    checkout(courseData: any, req: any): Promise<import("stripe").Stripe.Response<import("stripe").Stripe.Checkout.Session>>;
    webhookStripe(req: RawBodyRequest<Request>): Promise<void>;
}
