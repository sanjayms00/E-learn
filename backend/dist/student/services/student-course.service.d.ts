...
export declare class StudentCourseService {
    ...
    private readonly ratingReviewModel;
    private reviewRatingService;
    private signedUrlService;
    stripeClient: Stripe;
    constructor(courseModel: Model<Course>, instructorModel: Model<Instructor>, categoryModel: Model<Category>, studentModel: Model<Student>, ratingReviewModel: Model<RatingReview>, reviewRatingService: ReviewRatingService, signedUrlService: SignedUrlService);
    ...
    homeCourses(): Promise<any[]>;
    homeAllCounts(): Promise<{
        courseCount: number;
        categoryCount: number;
        ratingCount: number;
        instructorCount: number;
    ...
    searchCourse(searchText: string): Promise<any[]>;
    courseDetails(courseId: string): Promise<any>;
    getInstructors(): Promise<(import("mongoose").Document<unknown, {}, Instructor> & Instructor & {
        _id: Types.ObjectId;
    })[]>;
    getCategories(): Promise<(import("mongoose").Document<unknown, {}, Category> & Category & {
        _id: Types.ObjectId;
    })[]>;
    getFilteredCourses(filterData: any): Promise<any[]>;
    checkout(courseData: any, studentId: any): Promise<Stripe.Response<Stripe.Checkout.Session>>;
    paymentSuccessService(paymentIntentId: any, studentId: any, courseId: any): Promise<void>;
}
