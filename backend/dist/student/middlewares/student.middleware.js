...
let StudentMiddleware = class StudentMiddleware {
    ...
    async use(req, res, next) {
        ...
        if (authorizationHeader && authorizationHeader.startsWith('Bearer ')) {
            ...
            try {
                ...
                const studentId = new mongoose_2.Types.ObjectId(decodedToken.id);
...
exports.StudentMiddleware = StudentMiddleware = __decorate([
