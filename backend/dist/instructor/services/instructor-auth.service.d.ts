...
export declare class InstructorAuthService {
    private instructorModel;
    private jwtService;
    constructor(instructorModel: Model<Instructor>, jwtService: JwtService);
    signUp(signUpData: SignupDto): Promise<{
        ...
        user: {
            ...
            image: string;
            _id: any;
            $assertPopulated: <Paths = {}>(path: string | string[], values?: Partial<Paths>) => Omit<Instructor & {
            ...
            $inc: (path: string | string[], val?: number) => Instructor & {
                _id: import("mongoose").Types.ObjectId;
            };
            ...
            $set: {
                (path: string | Record<string, any>, val: any, type: any, options?: import("mongoose").DocumentSetOptions): Instructor & {
                    _id: import("mongoose").Types.ObjectId;
                };
                (path: string | Record<string, any>, val: any, options?: import("mongoose").DocumentSetOptions): Instructor & {
                    _id: import("mongoose").Types.ObjectId;
                };
                (value: string | Record<string, any>): Instructor & {
                    _id: import("mongoose").Types.ObjectId;
                };
            };
            ...
            depopulate: (path?: string | string[]) => Instructor & {
                _id: import("mongoose").Types.ObjectId;
            };
            ...
            getChanges: () => import("mongoose").UpdateQuery<Instructor & {
                _id: import("mongoose").Types.ObjectId;
            }>;
            id?: any;
            increment: () => Instructor & {
                _id: import("mongoose").Types.ObjectId;
            };
            init: (obj: import("mongoose").AnyObject, opts?: import("mongoose").AnyObject) => Instructor & {
                _id: import("mongoose").Types.ObjectId;
            };
            invalidate: {
            ...
            overwrite: (obj: import("mongoose").AnyObject) => Instructor & {
                _id: import("mongoose").Types.ObjectId;
            };
            $parent: () => import("mongoose").Document<any, any, any>;
            populate: {
                <Paths_1 = {}>(path: string | import("mongoose").PopulateOptions | (string | import("mongoose").PopulateOptions)[]): Promise<import("mongoose").MergeType<Instructor & {
                    _id: import("mongoose").Types.ObjectId;
                }, Paths_1>>;
                <Paths_2 = {}>(path: string, select?: string | import("mongoose").AnyObject, model?: Model<any, {}, {}, {}, any, any>, match?: import("mongoose").AnyObject, options?: import("mongoose").PopulateOptions): Promise<import("mongoose").MergeType<Instructor & {
                    _id: import("mongoose").Types.ObjectId;
                }, Paths_2>>;
            };
            populated: (path: string) => any;
            replaceOne: (replacement?: import("mongoose").AnyObject, options?: import("mongoose").QueryOptions<unknown>) => import("mongoose").Query<any, Instructor & {
                _id: import("mongoose").Types.ObjectId;
            }, {}, Instructor & {
                _id: import("mongoose").Types.ObjectId;
            }, "find">;
            save: (options?: import("mongoose").SaveOptions) => Promise<Instructor & {
                _id: import("mongoose").Types.ObjectId;
            }>;
            ...
            set: {
                <T_8 extends string | number | symbol>(path: T_8, val: any, type: any, options?: import("mongoose").DocumentSetOptions): Instructor & {
                    _id: import("mongoose").Types.ObjectId;
                };
                (path: string | Record<string, any>, val: any, type: any, options?: import("mongoose").DocumentSetOptions): Instructor & {
                    _id: import("mongoose").Types.ObjectId;
            ...
            updateOne: (update?: import("mongoose").UpdateWithAggregationPipeline | import("mongoose").UpdateQuery<Instructor & {
                _id: import("mongoose").Types.ObjectId;
            }>, options?: import("mongoose").QueryOptions<unknown>) => import("mongoose").Query<any, Instructor & {
                _id: import("mongoose").Types.ObjectId;
            }, {}, Instructor & {
                _id: import("mongoose").Types.ObjectId;
            }, "find">;
